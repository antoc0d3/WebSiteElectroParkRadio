...
!function(t){"use strict";function e(e,o){this.$el=t(e),this.opt=t.extend(!0,{},i,o),this.init(this)}var i={};e.prototype={init:function(e){t(document).on("click",function(i){var o=t(i.target);o.closest(e.$el.data("menu-toggle"))[0]?(o=o.closest(e.$el.data("menu-toggle")),e.$el.css(e.calcPosition(o)).toggleClass("show")):o.closest(e.$el)[0]||e.$el.removeClass("show")})},calcPosition:function(e){var i,o,s;return i=t(window).width(),s={top:(o=e.offset()).top+e.outerHeight()/2},o.left>i/2?(this.$el.addClass("menu--right").removeClass("menu--left"),s.right=i-o.left-e.outerWidth()/2,s.left="auto"):(this.$el.addClass("menu--left").removeClass("menu--right"),s.left=o.left+e.outerWidth()/2,s.right="auto"),s}},t.fn.menu=function(i){return this.each(function(){t.data(this,"menu")||t.data(this,"menu",new e(this,i))})}}(window.jQuery);
...
$(document).ready(function(){var e=["AIzaSyBv3l97UnzWC65YLSNtRJFhMJdGqlUG45g","chat-database-257ce.firebaseapp.com","https://chat-database-257ce.firebaseio.com","chat-database-257ce.appspot.com","initializeApp"],t={apiKey:e[0],authDomain:e[1],databaseURL:e[2],storageBucket:e[3]};firebase[e[4]](t);var a=firebase.database().ref("chat/"),i=firebase.database().ref("connect/"),s=localStorage.getItem("idOnline"),n=JSON.parse(sessionStorage.getItem("userData")),o=$(".chat-timeline"),c=$("body"),r=($(".menumobile"),$("#content"),$("#header"),$(".chat-online")),l=$("#chat-form"),d=$("#nav"),u=$("#nav-trigger"),h=($(".chat-timeline").get(0).scrollHeight,-1),p=$("#menu-close-m"),m=$("#loader-content"),g=$("title"),f=$(".cd-popup"),v=$("#jplayer_audio"),b=$(".chatline"),w=$("#nav .nav-label"),y=$("ul.tabs li"),k=$(".tab_content"),x=$("#chat_message_send"),S=$(".tabs > .tab");c.animate({opacity:1},5e3);function _(e){var t=$.ajax({url:e,method:"GET",dataType:"html",cache:!0});m.html(D),t.done(function(e){g.text(e.match(/<title[^>]*>([^<]+)<\/title>/)[1]);m.html(e.replace(/[\r\n]/g," ").match(/<section class='area'>(.*)<\/section>/)[0]);try{N(),$(".tabs .tab:first").click(),function(){var e=location.pathname.replace("/p/","").replace(".html",""),t=$(".status-msg-wrap:first");switch(e){case"tracklists":case"eventos":case"noticias":t.hide();break;case"videos":t.hide()}}(),B(),$(window).width()<740&&($(".tab_content:first").hide(),$(".tab_content:last").show(),$("ul.tabs li").removeClass("active"),$("ul.tabs li:first").addClass("active")),FB.XFBML.parse()}catch(e){console.log("not plugging facebook")}}),t.fail(function(){m.html(C)})}function D(){return"<div id='loading-page'><div class='outer'/><div class='inner'/></div>"}function C(){return"<div id='loading-page'><h4>No se pudo cargar la pagina ...</h4><a href='"+location.pathname+"' class='label'><button>cargar de nuevo <i class='fa fa-undo'></i> </button></a></div>"}function I(e){try{a.orderByKey().limitToFirst(1).once("value",function(e){var t=e.A.k.ba.key;a.child(t).remove()}),a.push().set(e),x.val(""),$(".chat-timeline").scrollTop($(".chat-timeline").get(0).scrollHeight,-1)}catch(e){alert("hubo un error por favor ingrese de nuevo")}}function T(){o.getNiceScroll().resize(),b.css({height:c.height()-45+"px"}),o.css({height:c.height()-140+"px"}),r.css({height:c.height()-140+"px"})}function B(){$(".tabs-widget-content").hide(),$("#widget-themater_tabs-1432447472-id0").fadeIn()}function P(){_("/index.html")}page("/",P),page("/p/tienda.html",function(){_("/p/tienda.html")}),page("/p/tracklists.html",function(){_("/search/label/tracklists")}),page("/p/eventos.html",function(){_("/search/label/eventos")}),page("/p/noticias.html",function(){_("/search/label/noticias")}),page("/p/videos.html",function(){_("/search/label/videos")}),page("/p/live.html",function(){_("/p/live.html")}),page("/:year/:month/:post",function(e){_("/"+e.params.year+"/"+e.params.month+"/"+e.params.post)}),page(),$(window).scroll(function(){$(window).scrollTop(),$(".fix-logo")}),$(window).mouseover(function(){c.getNiceScroll().resize()}),a.on("value",function(e){var t=e.val(),a=$(".user-message:last"),i="";o.empty();for(P in t)i+=(s=P,n=t,'<div class="user-message"><div class="user-message-photo"><img alt="'+n[s].imageProfile+'" src=" '+n[s].imageProfile+' "></div><div class="user-message-body"><div class="user-message-info"><strong class="user-message-name"><i class="fa fa-comment"></i>   '+n[s].name+'</strong></div><div class="user-message-content">'+n[s].message+"</div></div></div>");var s,n;o.append(i),a.hide().fadeIn("slow"),o.scrollTop(h),i=""},function(e){console.log("The read failed: "+e.code)}),i.on("value",function(e){var t=e.val(),a=$(".chat-online-count");r.empty();var i="";for(user in t)i+=(s=user,n=t,'<img class="user-message-photo" src='+n[s].photoURL+" title="+n[s].displayName+"/>");var s,n;r.append(i),connectsCounts=$(".chat-online > img").length,a.html('<strong><i class="fa fa-user-circle"></i></strong></p>'+connectsCounts+"</p>"),i=""},function(e){console.log("The read failed: "+e.code)}),$("#fbLogin").on("click",function(){var e=new firebase.auth.FacebookAuthProvider,t=$(".text-error.login"),a=$(".cd-popup");t.text(),firebase.auth().signInWithPopup(e).then(function(e){firebase.auth().onAuthStateChanged(function(e){e?(sessionStorage.setItem("userData",JSON.stringify(e.providerData[0])),localStorage.setItem("idOnline",e.providerData[0].uid),i.child(e.providerData[0].uid).set(e.providerData[0])):(alert("error al connectar."),location.reload())}),a.css({visibility:"hidden"})},function(e){t.text("ups... algo salio mal. intente de nuevo")})}),x.on("click",function(){null==sessionStorage.getItem("userData")&&$(".cd-popup").addClass("is-visible")}),window.onbeforeunload=function(){i.child(s).remove()},null!=sessionStorage.getItem("userData")&&(i.child(s).remove(),i.child(n.uid).set(n)),$(window).resize(T),T(),f.on("click",function(e){($(e.target).is(".cd-popup-close")||$(e.target).is(".cd-popup"))&&(e.preventDefault(),$(this).removeClass("is-visible"))}),u.on("click",function(e){u.attr("class").indexOf("close")>0?(u.attr("class","nav-trigger open"),d.attr("class","out")):(u.attr("class","nav-trigger close"),d.attr("class","in"))}),p.on("click",function(){u.attr("class","nav-trigger open"),d.attr("class","out")}),w.on("click",function(){u.attr("class","nav-trigger open"),d.attr("class","out")}),S.on("click",function(){S.removeClass("active"),$(this).addClass("active")}),$(document).keyup(function(e){"27"==e.which&&f.removeClass("is-visible")}),l.validate({rules:{chat_message_send:{required:!0,minlength:1,maxlength:99}},messages:{chat_message_send:{required:"",minlength:"Es necesario escribir caracteres.",maxlength:"Maximo de caracteres 99 por mensaje."}}}),o.scrollTop(h),x.keypress(function(e){99==this.value.length?e.preventDefault():this.value.length>99&&(this.value=this.value.substring(0,99))}),$(window).resize(function(){j()}),l.keypress(function(e){if(13==e.which&&!e.shiftKey){e.preventDefault();var t=function(){var e,t=JSON.parse(sessionStorage.getItem("userData")),a=x.val();e=null!=t?{name:t.displayName,message:a,imageProfile:"https://graph.facebook.com/"+t.uid+"/picture?type=square"}:null;return e}();1==function(e){if(1==l.valid()&&null!=e)return!0}(t)&&I(t)}});function j(){$(window).width()>991?($("#tab2, #tab1").show(),$(".tabs").hide()):(function(){switch($(".tabs > li.active").text()){case"WEB":return $("#tab2");case"CHAT":return $("#tab1")}}().hide(),$(".tabs").show())}!function(e,t,a){var i,s=e.getElementsByTagName("script")[0];e.getElementById("facebook-jssdk")||((i=e.createElement("script")).id="facebook-jssdk",i.src="https://connect.facebook.net/en_ES/sdk.js#xfbml=1&version=v2.12&appId=1466024870318151&autoLogAppEvents=1",s.parentNode.insertBefore(i,s))}(document),$(".tab_content").hide(),$(".tab_content:last").show(),y.click(function(){y.removeClass("active"),$(this).addClass("active"),k.hide(),$("#"+$(this).attr("rel")).fadeIn(),N()}),$(window).width()>991&&j();function N(){$(window).width()>991&&$(".chat-timeline , body").niceScroll({cursorcolor:"#879e9f",cursoropacitymin:.4,background:"transparent",autohidemode:!1,cursorborder:"0",cursorminheight:30})}v.jPlayer({ready:function(e){$(this).jPlayer("setMedia",{mp3:"https://net1-cope-rrcast.flumotion.com/cope/net1.mp3"}).jPlayer("play")},timeupdate:"",durationchange:"",cssSelectorAncestor:"#jp_gui_audio",cssSelector:{currentTime:""},swfPath:"lib",supplied:"mp3",autoPlay:!0,smoothPlayBar:!0,keyEnabled:!0,wmode:"window"});$(".draggable").draggabilly({handle:".handle"});$(".player-stick").stickit(),$(".player-control").menu(),N(),B()});
